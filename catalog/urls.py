...
urlpatterns = [
    ...
    path("product_list/catalog", cache_page(60)(ProductListView.as_view()), name="product_list"),
    path("product_detail/catalog/<int:pk>/", cache_page(60)(ProductDetailView.as_view()), name="product_detail"),
